  ...
  return (
    <ProtectedRoute>
      <div className="w-full px-4 sm:px-6 lg:px-8 py-6 max-w-[1920px] mx-auto">
        ...
        <div className="p-4 rounded-2xl bg-amber-50/80 text-amber-950 text-xs border border-amber-200 shadow-sm flex items-start gap-3">
          <ShieldAlert className="w-5 h-5 text-amber-600 shrink-0 mt-0.5" />
          <div>
            <strong className="text-amber-950 block font-bold mb-0.5">Medical & Regulatory Disclaimer:</strong>
            CardioAI is an AI screening prototype developed for research and educational demonstrations. Results generated by the system do not constitute medical diagnosis or diagnostic advice. Please consult a licensed cardiologist or physician for evaluation of cardiac symptoms.
          </div>
        </div>
